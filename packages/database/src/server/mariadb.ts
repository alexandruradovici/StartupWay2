	...
	private async createDB():Promise<boolean> {
		try {
			...
			if (r[0] === undefined || r[0].length < 1) {
				...
				await auxPool.query(queryOptions);
				...
				// users
				await tablePool.query("CREATE TABLE `users` (`userId` varchar(100) NOT NULL, `firstName` varchar(50) NOT NULL,`lastName` varchar(50) NOT NULL,`username` varchar(120) NOT NULL,`password` varchar(90) NOT NULL,`email` varchar(100) NOT NULL,`phone` varchar(15) NOT NULL,`birthDate` datetime NOT NULL,`avatarUu` varchar(100) NOT NULL,`socialMedia` text NOT NULL,`userDetails` text NOT NULL,`role` text NOT NULL,`lastLogin` datetime NOT NULL,PRIMARY KEY (`userId`),UNIQUE KEY `username` (`username`),UNIQUE KEY `username_password` (`username`,`password`)) ENGINE=InnoDB");
				// products
				await tablePool.query("CREATE TABLE `products` (`productId` varchar(100) NOT NULL, `startupName` varchar(30) NOT NULL,`businessTrack` varchar(60) NOT NULL,`teamType` varchar(30) NOT NULL,`workshopDay` varchar(30) NOT NULL,`mentorId` varchar(100) NOT NULL,`descriptionRO` varchar(600) NOT NULL,`descriptionEN` varchar(600) NOT NULL,`pendingDescriptionRO` varchar(600) NOT NULL,`pendingDescriptionEN` varchar(600) NOT NULL,`userId` varchar(100) DEFAULT NULL,`productDetails` text NOT NULL,`updatedAt` timestamp NOT NULL,`lastMentorUpdate` timestamp NOT NULL,PRIMARY KEY (`productId`),UNIQUE KEY `startupName` (`startupName`),KEY `FK_99d90c2a483d79f3b627fb1d5e9` (`userId`),CONSTRAINT `FK_99d90c2a483d79f3b627fb1d5e9` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB");
				// teams
				await tablePool.query("CREATE TABLE `teams` (`teamId` varchar(100) NOT NULL, `productId` varchar(100) NOT NULL,`year` int(11) NOT NULL,`location` varchar(100) NOT NULL,`teamName` varchar(120) NOT NULL,`teamDetails` text NOT NULL,PRIMARY KEY (`teamId`),UNIQUE KEY `teamName` (`teamName`),UNIQUE KEY `REL_004cf2c4fc89735735b1e77a6d` (`productId`),CONSTRAINT `FK_004cf2c4fc89735735b1e77a6db` FOREIGN KEY (`productId`) REFERENCES `products` (`productId`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB");
				// sessions
				await tablePool.query("CREATE TABLE `sessions` (`userId` varchar(100) NOT NULL,`sessionId` varchar(100) NOT NULL, `token` varchar(150) NOT NULL,`createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),PRIMARY KEY (`sessionId`),KEY `FK_57de40bc620f456c7311aa3a1e6` (`userId`),CONSTRAINT `FK_57de40bc620f456c7311aa3a1e6` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB");
				// userTeams
				await tablePool.query("CREATE TABLE `userTeams` (`userProductId` varchar(100) NOT NULL, `userId` varchar(100) NOT NULL,`teamId` varchar(100) NOT NULL,`role` varchar(10) NOT NULL,PRIMARY KEY (`userProductId`),KEY `FK_83be579ba81c5f68b6792c4fe4f` (`userId`),KEY `FK_be4217fd0c329929e298f276f3e` (`teamId`),CONSTRAINT `FK_83be579ba81c5f68b6792c4fe4f` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE NO ACTION ON UPDATE NO ACTION,CONSTRAINT `FK_be4217fd0c329929e298f276f3e` FOREIGN KEY (`teamId`) REFERENCES `teams` (`teamId`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB");
				// userActivities
				await tablePool.query("CREATE TABLE `userActivities` (`activityId` varchar(100) NOT NULL, `userId` varchar(100) NOT NULL,`teamId` varchar(100) NOT NULL,`date` datetime NOT NULL,`description` varchar(1000) NOT NULL,`noOfHours` int(11) NOT NULL,PRIMARY KEY (`activityId`),KEY `FK_274a34b4f5e47d9ca5ddeccc922` (`userId`),KEY `FK_ba771a2ce2af5e6cfa9e552b6db` (`teamId`),CONSTRAINT `FK_274a34b4f5e47d9ca5ddeccc922` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE NO ACTION ON UPDATE NO ACTION,CONSTRAINT `FK_ba771a2ce2af5e6cfa9e552b6db` FOREIGN KEY (`teamId`) REFERENCES `teams` (`teamId`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB");
				// bModelCanvas
				await tablePool.query("CREATE TABLE `bModelCanvas` (`modelId` varchar(100) NOT NULL, `productId` varchar(100) NOT NULL,`date` datetime NOT NULL,`fields` text NOT NULL,PRIMARY KEY (`modelId`),KEY `FK_9b5ad0d5379a1f0e9165fc40408` (`productId`),CONSTRAINT `FK_9b5ad0d5379a1f0e9165fc40408` FOREIGN KEY (`productId`) REFERENCES `products` (`productId`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB");
				// workshops
				await tablePool.query("CREATE TABLE `workshops` (`workshopId` varchar(100) NOT NULL, `workshopName` varchar(120) NOT NULL,PRIMARY KEY (`workshopId`),UNIQUE KEY `workshopName` (`workshopName`)) ENGINE=InnoDB ");
				// workshopInstances
				await tablePool.query("CREATE TABLE `workshopInstances` (`workshopInstanceId` varchar(100) NOT NULL, `workshopId` varchar(100) NOT NULL,`teamId` varchar(100) NOT NULL,`trainerName` varchar(100) NOT NULL,`workshopDate` datetime NOT NULL,`workshopDetails` text NOT NULL,PRIMARY KEY (`workshopInstanceId`),UNIQUE KEY `workshopInstanceId` (`workshopInstanceId`),KEY `FK_2e20c0c8114652d2f442cedc6e1` (`workshopId`),KEY `FK_49ca002b40c714b757ae74c323a` (`teamId`),CONSTRAINT `FK_2e20c0c8114652d2f442cedc6e1` FOREIGN KEY (`workshopId`) REFERENCES `workshops` (`workshopId`) ON DELETE NO ACTION ON UPDATE NO ACTION,CONSTRAINT `FK_49ca002b40c714b757ae74c323a` FOREIGN KEY (`teamId`) REFERENCES `teams` (`teamId`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB");
				// workshopAttendances
				await tablePool.query("CREATE TABLE `workshopAttendances` (`attendanceId` varchar(100) NOT NULL, `workshopInstanceId` varchar(100) NOT NULL,`attendanceDate` datetime NOT NULL,`userId` varchar(100) NOT NULL,PRIMARY KEY (`attendanceId`),UNIQUE KEY `attendanceId` (`attendanceId`),KEY `FK_eb9bcf0843c6ac3782a9f2fa4cf` (`workshopInstanceId`),KEY `FK_772b3a178a351d44ea62d230f53` (`userId`),CONSTRAINT `FK_772b3a178a351d44ea62d230f53` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE NO ACTION ON UPDATE NO ACTION,CONSTRAINT `FK_eb9bcf0843c6ac3782a9f2fa4cf` FOREIGN KEY (`workshopInstanceId`) REFERENCES `workshopInstances` (`workshopInstanceId`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB");
				// uploadDownload
				await tablePool.query("CREATE TABLE `uploadDownload` (`uuid` varchar(100) NOT NULL,`productId` varchar(100) NOT NULL,`fileType` varchar(255) NOT NULL,`extension` varchar(255) NOT NULL,`uploadTime` datetime NOT NULL,PRIMARY KEY (`uuid`),KEY `FK_0af268615f35d00781c400254ae` (`productId`),CONSTRAINT `FK_0af268615f35d00781c400254ae` FOREIGN KEY (`productId`) REFERENCES `products` (`productId`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB");
				// recoveries
				await tablePool.query("CREATE TABLE `recoveries` (`recoveryId` varchar(100) NOT NULL, `userId` varchar(100) NOT NULL,`email` varchar(100) NOT NULL,`recoveryLink` varchar(100) NOT NULL,PRIMARY KEY (`recoveryId`),UNIQUE KEY `token` (`recoveryLink`),KEY `FK_7902dfcee5a16cb1377e04d3d7a` (`userId`),CONSTRAINT `FK_7902dfcee5a16cb1377e04d3d7a` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE NO ACTION ON UPDATE NO ACTION) ENGINE=InnoDB");
				// feeds
