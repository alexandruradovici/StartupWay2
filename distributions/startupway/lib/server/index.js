...
var setup = function () { return __awaiter(void 0, void 0, void 0, function () {
    var mariadb, server, resp, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                mariadb = server_2.MariaDBServer.getInstance();
                server = server_1.Server.getInstance();
                return [4 /*yield*/, mariadb.start()];
            case 1:
                resp = _a.sent();
                if (resp) {
                ...
                server.registerRouterUI(express_1.default.static(path_1.default.resolve(__dirname, "../ui")));
